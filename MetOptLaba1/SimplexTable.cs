...
namespace MetOptLaba1
{
    ...
    public class SimplexTable
    {
        ...
        public SimplexTable(Fraction[,] content, int[] freeVariables, int[] basisVariables)
        {
        ...
        public SimplexTable(Fraction[,] content, Fraction[] x0)
        {
            this.content = content;
        ...
        public DataGrid getDataGrid(int idx)
        {
            // Создаём DataGrid
